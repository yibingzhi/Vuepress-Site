...
permalink: /java/基础语法/p160sw1s/
---

## 概述

面向对象编程（Object-Oriented
Programming，OOP）是一种编程范式，它将现实世界中的事物抽象为对象，通过对象之间的交互来解决问题。Java是一门完全面向对象的语言，理解面向对象的概念对Java开发至关重要。
...
java -cp src/main/java com.ibz.基础.oop.OOPDemo
```
...
```bash
mvn compile
mvn exec:java -Dexec.mainClass="com.ibz.基础.oop.OOPDemo"
```
