...
export const zhNavbar = defineNavbarConfig([
...

    {
        ...
        items: [
            ...
            {text: '日志 SLF4J', link: '/notes/java/高级特性/日志体系SLF4J与Logback详解.md'},
            ...
            {text: 'Boot3 迁移', link: '/notes/java/SpringBoot/SpringBoot3迁移指南.md'},
            {text: 'JWT 认证', link: '/notes/java/SpringBoot/JWT认证实战.md'},
            {text: 'Spring Cloud', link: '/notes/java/微服务/SpringCloud微服务详解.md'},
            {text: 'Tracing', link: '/notes/java/微服务/MicrometerTracing详解.md'},
    ...
    },
    {
        ...
        items: [
            ...
            {text: 'CSS 现代布局', link: '/notes/前端/CSS布局现代指南.md'},
            {text: 'JavaScript', link: '/notes/前端/js.md'},
            {text: 'HTTP / 浏览器网络', link: '/notes/前端/HTTP与浏览器网络详解.md'},
    ...
    },
    {
        ...
        items: [
            ...
            {text: '面试常考题型', link: '/notes/数据结构与算法/面试常考算法题型.md'},
        ],
    },
    {
        text: '规范 / 工程',
        items: [
            ...
            {text: '单元测试 JUnit5', link: '/notes/开发规范/单元测试JUnit5详解.md'},
            {text: 'Code Review / Commits', link: '/notes/开发规范/代码评审与ConventionalCommits.md'},
        ],
    },
    {
        text: 'AI',
    ...
    },
    {
        ...
        items: [
            ...
            {text: 'Shell 脚本', link: '/notes/运维/Shell脚本实战.md'},
